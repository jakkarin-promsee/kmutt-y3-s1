...
fill in every `<...>` below.** The `INDEX.md` mention below is a placeholder in backticks — once the
folder exists, turn it into a real wiki-link per the `vault-writing` skill, i.e.
