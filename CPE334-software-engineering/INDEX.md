...
- `assignment/Lab-1/Lab1_Labsheet.pdf` — **Lab 1 lab sheet** "TokTickIT Full-Stack Hello World
  ...
  *(text cache: `Lab-1/Lab1_Labsheet.md`)*
- `assignment/Lab-1/Lab1_Glossary.pdf` — **Lab 1 glossary** "Appendix — Glossary of Key Terms".
  ...
  *(text cache: `Lab-1/Lab1_Glossary.md`)*
- `assignment/Lab-1/Lab1_Git_GitHub_CheatSheet.pdf` — **Lab 1 cheat sheet** for Git & GitHub.
  ...
  *(text cache: `Lab-1/Lab1_Git_GitHub_CheatSheet.md`)*
...
- `CPE334_Syllabus_1-2026.md` — (text cache of `CPE334_Syllabus_1-2026.pdf`). Regenerated
  2026-08-04 by a Sonnet subagent reading all 4 pages; the instructor/TA list, grading split and
  the 14-week schedule are proper Markdown tables, so the old column-shift caveat no longer applies.
...
- `Lecture+1+-+Introduction.md` — (text cache of `Lecture+1+-+Introduction.pdf`). Regenerated
  2026-08-04 by a Sonnet subagent reading all 46 slides; one `## Slide N` heading per slide, slide
  text and shell/Git snippets verbatim, and 29 diagrams captured as one-line descriptions (SDLC
  phases, process models, branching model, merge types). Descriptions, not pictures — read the PDF
  if a diagram's exact shape matters.
